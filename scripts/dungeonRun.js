...
const scene = {
    ...
    create: function()
    {
        ...
        this.game.dungeon.rooms[this.actual].enemies.summonEnemies(this,this.hero, this.hero.weaponManager.weapon,this.tileMap.Walls); //invoca a los enemigos, y activa las físicas y colisiones
